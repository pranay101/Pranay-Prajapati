...
const experienceData: ExperienceItem[] = [
    {
        ...
        date: 'Present',
        description: [
            'Architected and deployed the entire zo world admin dashboard using Next.js and Tailwind CSS.',
            'Spearheaded the development of the zo world platform and multiple city-specific landing pages',
            'Implemented responsive design patterns and optimized performance for better user experience',
            'Collaborated with cross-functional teams to translate business requirements into scalable technical solutions',
            'Learnt to build products and not just writing code.',
        ],
        type: 'work',
        isPresent: true,
    },
